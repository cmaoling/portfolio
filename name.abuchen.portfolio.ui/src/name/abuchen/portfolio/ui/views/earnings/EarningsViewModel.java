...
public class EarningsViewModel
{
    public enum Mode
    {
        ...
        EARNINGS(Messages.LabelEarnings, AccountTransaction.Type.DIVIDENDS, AccountTransaction.Type.DIVIDEND_CHARGE, // $NON-NLS-1$
                        AccountTransaction.Type.INTEREST, AccountTransaction.Type.INTEREST_CHARGE), // $NON-NLS-1$
