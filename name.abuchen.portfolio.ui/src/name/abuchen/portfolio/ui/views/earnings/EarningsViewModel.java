...
public class EarningsViewModel
{
    public enum Mode
    {
        ...
        EARNINGS(Messages.LabelEarnings, AccountTransaction.Type.DIVIDENDS, AccountTransaction.Type.DIVIDEND_CHARGE,
                AccountTransaction.Type.INTEREST, AccountTransaction.Type.INTEREST_CHARGE),
        TAXES(Messages.ColumnTaxes, AccountTransaction.Type.DIVIDENDS, AccountTransaction.Type.DIVIDEND_CHARGE,
                        AccountTransaction.Type.INTEREST, AccountTransaction.Type.INTEREST_CHARGE,
                        AccountTransaction.Type.TAXES, AccountTransaction.Type.TAX_REFUND),
        FEES(Messages.ColumnFees, AccountTransaction.Type.DIVIDENDS, AccountTransaction.Type.DIVIDEND_CHARGE,
                        AccountTransaction.Type.INTEREST, AccountTransaction.Type.INTEREST_CHARGE,
                        AccountTransaction.Type.FEES, AccountTransaction.Type.FEES_REFUND),
        TRADES(Messages.LabelEarningsTradeProfitLoss, null), //
        ALL("\u2211", AccountTransaction.Type.DIVIDENDS, AccountTransaction.Type.DIVIDEND_CHARGE, //$NON-NLS-1$
                        AccountTransaction.Type.INTEREST, AccountTransaction.Type.INTEREST_CHARGE,
                        AccountTransaction.Type.TAXES, AccountTransaction.Type.TAX_REFUND,
                        AccountTransaction.Type.FEES, AccountTransaction.Type.FEES_REFUND);
