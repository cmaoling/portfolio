...
public class PeerListView extends AbstractListView implements ModificationListener
{
    ...
    {
        System.err.println(">>>> PeerListView::resetInput() isFiltered   : " + isFiltered);
        PeerList peers = new PeerList(getClient().getPeers());
        if (!isFiltered)
            peers = peers.addAccounts(getClient().getAccounts());
        System.err.println(">>>> PeerListView::resetInput() peers   : " + peers.toString());
    ...
    public void onModified(Object element, Object newValue, Object oldValue)
    {
        if (element instanceof Peer)
        {
            ...
            if (p.links2Account())
                ...
                {
                    System.err.println(">>>> PeerListView::onModified() removePeer   : " + p.toString());
    ...
    protected void createTopTable(Composite parent)
    {
        ...
        List<Account> accounts = getClient().getAccountsWithIBAN(false);
